...
function ol_content_caption(text, title, close) {
	...
	if (o3_capicon != "") o3_capicon = "<IMG SRC=file:///C|/Programme/xampplite/htdocs/Webseiten/script/javascript/%22%22+o3_capicon+%22/%22> ";

	if (close != "") {
		if (o3_css == CSSCLASS) closing = "<TD ALIGN=RIGHT><A HREF=file:///C|/Programme/xampplite/htdocs/Webseiten/script/javascript/%22/%22 "+closeevent+"=\"return cClick();\" class=\""+o3_closefontclass+"\">"+close+"</A></TD>";
		if (o3_css == CSSSTYLE) closing = "<TD ALIGN=RIGHT><A HREF=file:///C|/Programme/xampplite/htdocs/Webseiten/script/javascript/%22/%22 "+closeevent+"=\"return cClick();\" style=\"color: "+o3_closecolor+"; font-family: "+o3_closefont+"; font-size: "+o3_closesize+o3_closesizeunit+"; text-decoration: "+o3_closedecoration+"; font-weight: "+o3_closeweight+"; font-style:"+o3_closestyle+";\">"+close+"</A></TD>";
		if (o3_css == CSSOFF) closing = "<TD ALIGN=RIGHT><A HREF=file:///C|/Programme/xampplite/htdocs/Webseiten/script/javascript/%22/%22 "+closeevent+"=\"return cClick();\"><FONT COLOR=\""+o3_closecolor+"\" FACE=\""+o3_closefont+"\" SIZE=\""+o3_closesize+"\">"+close+"</FONT></A></TD>";
	}
